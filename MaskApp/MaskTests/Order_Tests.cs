...
namespace MaskTests
{
    public class OrderTest {
        //creating mask objects to then test through all the tests
        ...
        public void SetPriceTest() {
            //creating the order using the pre-existing mask objects
            Order order1 = new Order(newMask1, 3);
            Order order2 = new Order(newMask2, 10);
            
            //checking the price entered equals the generated price from object
